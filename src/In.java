 ...
 *  Execution: java In (basic test --- see a source for required files)
 * <p>
 ...
 * <p>
 * Like {@link Scanner}, reading a token also consumes the preceding Java
 * space, reading a full line consumes
 * the following end-of-line delimiter, while reading a character consumes
 * nothing extra.
 * <p>
 * Space is defined in {@link Character#isWhitespace(char)}. Newlines
...
public final class In {
    ...
    // makes space characters significant
    ...
    public In(String s) {
        try {
            // first try to read file from the local file system
            ...
            // in order to set User-Agent, replace the above line with these two lines
    ...
    public static void main(String[] args) {
        ...
        // read one line at a time from file using a relative path
    ...
    /**
     * Is the input empty (except possibly for space)? Use this
     * to know whether the next call to {@link #readString()} will succeed.
     */
    ...
    public String readAll() {
        ...
        // not that important to reset delimiter, since now the scanner is empty
